...
public class Meter implements Serializable {
    ...
    /** full constructor */
    public Meter(Boolean step1, Boolean step2, Boolean step3, Boolean step4, Boolean step5, Boolean step6, Boolean step7, Boolean step8, Boolean step9, Boolean step10, Boolean step11, Boolean step12, Boolean group1, Boolean group2, Boolean group3, Boolean group4, Boolean group5, Boolean group6, Boolean group7, Boolean group8, Boolean group9, Boolean group10, Boolean group11, Boolean group12, Date check1, Date check2, Date check3, Date check4, Date check5, Date check6, Date check7, Date check8, Date check9, Date check10, Date check11, Date check12, northwest.common.value.BillSchedule schedule, northwest.common.value.BillDetail billdetail, northwest.common.value.Bill bill, northwest.common.value.Product product) {
        this.step1 = step1;
        this.step2 = step2;
        this.step3 = step3;
        this.step4 = step4;
    ...
    public Long getScheduleId() {
        if (this.schedule != null && this.schedule.getId() != null)
