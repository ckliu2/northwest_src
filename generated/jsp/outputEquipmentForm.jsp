  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="outputEquipment.name"/></td>
        <td class="cInputColumn">
            <ww:textfield name="outputEquipment.name" value="%{outputEquipment.name}" maxlength="0" cssClass="cInputTextField" />
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="outputEquipment.memo"/></td>
        <td class="cInputColumn">
            <ww:textfield name="outputEquipment.memo" value="%{outputEquipment.memo}" maxlength="0" cssClass="cInputTextField" />
        </td>
    </tr>
