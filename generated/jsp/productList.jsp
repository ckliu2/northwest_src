...
<display:table name="productList" class="list" cellspacing="1" requestURI="" id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <display:column property="productName" sortable="true" titleKey="product.productName" style="text-align:left" />
    <display:column property="unit" sortable="true" titleKey="product.unit" style="text-align:left" />
    <display:column property="productClass.caption_" sortable="true" titleKey="product.productClass" style="text-align:left"/>
    <display:column property="productUnit.caption_" sortable="true" titleKey="product.productUnit" style="text-align:left"/>
    <display:column property="combine" sortable="true" titleKey="product.combine" style="text-align:left" />
