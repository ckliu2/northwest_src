 ...
 * 
 * Copyright 2006 Chih-Shyang Chang Created Date: Sat Oct 01 18:37:38 CST 2011
 */
...
public class ProductClassAction extends CommonActionSupport {
	...
	public String findProduct1JSON() {
		JSONArray ja = new JSONArray();
		try {
			List<Product> ls = queryProductList();
			for (int i = 0; i < ls.size(); i++) {
			...
			System.out.println("findProduct1JSON error= " + e.toString());
		}
		return ja.toString();
	}
